...
/* base.html.twig */
class __TwigTemplate_c51a649234ff853145b6d6c685d01e49 extends Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body>
        ...
        echo "                        <li class=\"nav-item\">
                            <a class=\"nav-link\" href=\"";
        // line 32
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("ChessOnline");
        echo "\">ChessOnline</a>
                        </li>
                        ";
        // line 34
...
";
    ...
    {
        return array (  216 => 48,  206 => 47,  193 => 14,  183 => 13,  170 => 10,  160 => 9,  141 => 5,  129 => 55,  127 => 47,  121 => 43,  115 => 40,  112 => 39,  106 => 36,  103 => 35,  101 => 34,  96 => 32,  93 => 31,  87 => 28,  84 => 27,  82 => 26,  72 => 19,  67 => 16,  65 => 13,  62 => 12,  59 => 9,  53 => 5,  47 => 1,);
    }
...
<html>
    ...
    <body>
            <nav class=\"navbar navbar-expand-lg navbar-light bg-light\">
                <a class=\"navbar-brand\" href=\"{{ path('News') }}\">Rules</a>
                <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarSupportedContent\" aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">
                    <span class=\"navbar-toggler-icon\"></span>
                </button>
                ...
                <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
                    <ul class=\"navbar-nav mr-auto\">
                        {% if app.user %}
                        <li class=\"nav-item\">
                            <a class=\"nav-link\" href=\"{{ path('Competitions') }}\">Competitions</a>
                        </li>
                        {% endif %}
                        <li class=\"nav-item\">
                            <a class=\"nav-link\" href=\"{{ path('ChessOnline') }}\">ChessOnline</a>
                        </li>
                        {% if app.user %}
                        <li class=\"nav-item\">
...
", "base.html.twig", "C:\\Users\\Maxsi\\Documents\\GitHub\\-ChessClub\\ChessWebsite\\templates\\base.html.twig");
    }
}
