...
class __TwigTemplate_f55bd96117667570f8b532a54b768b45 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        ";
        // line 20
        if (twig_in_filter("ROLE_ADMIN", twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 20, $this->source); })()), "user", [], "any", false, false, false, 20), "roles", [], "any", false, false, false, 20))) {
            // line 21
            echo "
            <h2>Admin Panel</h2>
            <span> To Manually Create a new user, Edit/Remove an existing User <br>
            Then follow this <a href=\"";
            // line 24
    ...
    {
        return array (  110 => 27,  104 => 24,  99 => 21,  97 => 20,  85 => 11,  82 => 10,  74 => 7,  71 => 6,  68 => 5,  58 => 4,  35 => 1,);
    }
    ...
    {% block body %}
        ...
        {% if 'ROLE_ADMIN' in app.user.roles %}
            ...
            <h2>Admin Panel</h2>
            <span> To Manually Create a new user, Edit/Remove an existing User <br>
            Then follow this <a href=\"{{ path('user_index') }}\">link</a> </span>

        {% endif %}

    {% endblock %}
", "Home/Profile.html.twig", "C:\\Users\\Maxsi\\Documents\\GitHub\\-ChessClub\\ChessWebsite\\templates\\Home\\Profile.html.twig");
    }
}
